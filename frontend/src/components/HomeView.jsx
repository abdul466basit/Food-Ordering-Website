        ...
        <>
            ...
            <div className="row gap-25 margin-left-5">
                ...
                <div className="row gap-2">
                    ...
                    <div className="product-price-add">
                        ...
                        <button className="product-add" onClick={()=> addtocart(item.ProductID)}>
            ...
            <div className="weekly-special">
                ...
                <div className="weekly-inside-cards row">
                    ...
                    <div className="weekly-cards">
                        ...
                        <div className="inside-weekly column">
                            ...
                            <div className="weekly-title">
                                <h4>Red Hot Temptations: A Spicy Affair with Tikka</h4>    
                            </div>

                            <div className="rating-weekly">
                            ...
                            <div className="weekly-price">
                                ...
                                <button className="product-add"> <MdAdd size={30} /> </button>
                            </div>
                    ...
                    <div className="weekly-cards">
                        <div className="weekly">
                            <div className="discount-line">50%</div>
                        ...
                        <div className="inside-weekly column">
                            ...
                            <div className="weekly-title">
                                <h4>Berry Bliss Sparkle: Strawberry Limca Refreshment</h4>    
                            </div>
                    ...
                    <div className="weekly-cards">
                        ...
                        <div className="weekly">
                            <div className="discount-line">30%</div>
                        ...
                        <div className="inside-weekly column">
                            ...
                            <div className="weekly-title">
                                <h4>Berrylicious Ice Cream: Taste the Strawberry Magic</h4>    
                            </div>
